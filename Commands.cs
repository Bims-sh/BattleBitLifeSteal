...
public abstract class ApiCommand
{
    ...
    public virtual Command ChatCommand(LifeStealPlayer player, ChatChannel channel, string msg)
    {
        return null;
    }
}
...
public class HelpCommand : ApiCommand
{
    ...
    public override Command ChatCommand(LifeStealPlayer player, ChatChannel channel, string msg)
    {
        return new Command()
        {
